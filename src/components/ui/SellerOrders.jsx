                      ...
                      {updatingOrderId === order._id ? (
                        <>
                          <select
                            ...
                            className="select select-bordered select-sm bg-gray-800 text-white focus:ring-teal-500 focus:border-teal-500 w-full sm:w-auto"
                          >
                          ...
                          <button
                            ...
                            className="btn btn-sm bg-teal-500 border-none hover:bg-teal-600 text-white w-full sm:w-auto"
                          >
                            Update
                          </button>
                          <button
                        ...
                        <>
                          <button
                            ...
                            className="btn btn-sm bg-blue-500 border-none hover:bg-blue-600 text-white w-full sm:w-auto"
                          >
                            Edit Status
                          </button>
                          {order.item.complaint?.status === "Open" && order.item.sellerStatus === "Delivered" && (
                            <button
                              ...
                              className="btn btn-sm bg-purple-500 border-none hover:bg-purple-600 text-white w-full sm:w-auto"
                            >
                              Resolve Complaint
                            </button>
                          )}
                            ...
                            order.item.sellerStatus !== "Shipped" && (
                              <>
                                <button
                                  ...
                                  className="btn btn-sm bg-green-500 border-none hover:bg-green-600 text-white w-full sm:w-auto"
                                >
                                  Ready to Ship
                                </button>
                                <button
                                  onClick={() => cancelOrder(order._id, order.item.productId._id)}
                                  className="btn btn-sm bg-red-600 border-none hover:bg-red-700 text-white w-full sm:w-auto"
                                >
                                  Cancel Order
                                </button>
                              </>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          {order.item.complaint && (
                            <div className="col-span-1 md:col-span-2">
                              ...
                              <p><strong>Status:</strong> {order.item.complaint.status || 'N/A'}</p>
                              <p><strong>Refund Requested:</strong> {order.item.complaint.refundRequested ? 'Yes' : 'No'}</p>
                              {order.item.complaint.refundRequested && (
                                <p><strong>Refund Amount:</strong> {order.item.complaint.refundAmount ? `$${order.item.complaint.refundAmount.toLocaleString('en-US', { minimumFractionDigits: 2 })}` : 'N/A'}</p>
                              )}
